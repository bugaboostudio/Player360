# Documentação Técnica — Player360

Este documento reúne os detalhes técnicos do projeto: requisitos, arquitetura, funcionamento interno, configuração, build e CI/CD. Para uma apresentação geral do projeto, veja o [README](../README.md).
